!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = t(
        require("element-ui"),
        require("@panhezeng/utils/dist/check-upload.js"),
        require("@panhezeng/utils/dist/get-object-item-by-path.js"),
        require("@panhezeng/el-popover-dialog")
      ))
    : "function" == typeof define && define.amd
    ? define("ElSingleUpload", [
        "element-ui",
    ...
    function(e, t, n) {
      ...
      var i = function() {
        ...
        return i(
          ...
          [
                        ...
                        [
                          "image" === t.typeClassName
                            ...
                            : i(
                                ...
                                [
                                  t._v(
                                    t._s(t.file ? t.file.name : t.urlInternal)
                                  )
                                ]
                              )
                        ]
            ...
            t._v(" "),
            100 !== t.percentage
              ? i("el-progress", { attrs: { percentage: t.percentage } })
              : t._e(),
            t._v(" "),
            t.$attrs.disabled
              ? t._e()
              : i(
                  ...
                  [
                    t.urlInternal
                      ? i("i", { staticClass: "re-upload-btn el-icon-upload" })
                      : i("i", { staticClass: "upload-btn el-icon-upload" })
                  ]
                ),
            t._v(" "),
            ...
            t._v(" "),
            t.tip
              ? i("div", { staticClass: "tip" }, [t._v(t._s(t.tip))])
              : t._e(),
            t._v(" "),
            t._t("default")
          ],
      ...
      var r = n(0),
        ...
        p = {
          ...
          props: {
            ...
            type: {
              validator: function(e) {
                return (
                  "" === e || /^(image|audio|video|text|application|\.)/.test(e)
                );
              },
              default: "image"
            },
          ...
          computed: {
            ...
            typeClassName: function() {
              return /^\.(png|jpe?g|gif|svg|webp)/.test(this.type) ||
                ...
                ? "audio"
                : /^\.(mp4|webm)/.test(this.type) || /^video/.test(this.type)
                ? "video"
                : "";
            }
          },
          methods: {
            setUrl: function(e) {
              var t = "[object String]" === Object.prototype.toString.call(e);
              t && (t = /^https?:\/\//i.test(e)),
                t
                  ? ((this.urlInternal = e),
                    this.$nextTick(function() {
                      ...
                      this.$refs.media &&
                        (this.$refs.media.addEventListener(
                          "loadedmetadata",
                          function(t) {
                            e.$emit("media-duration", e.$refs.media.duration);
                          },
                          !0
                        ),
                        this.$refs.media.addEventListener(
            ...
            errorUpload: function(e, t) {
              (this.percentage = 100),
                this.error ? this.error(e, t) : r.Message.error("上传失败"),
      ...
      n(6);
      var c = (function(e, t, n, i, r, o, l, a) {
        var s,
        ...
        if (
          ...
          if (d.functional) {
            ...
            d.beforeCreate = p ? [].concat(p, s) : [s];
          }
        return { exports: e, options: d };
      })(p, i, [], !1, null, null, null);
    ...
    function(e, t, n) {
      ...
      function i(e, t) {
        for (var n = [], i = {}, r = 0; r < t.length; r++) {
          var o = t[r],
            l = o[0],
            a = { id: e + ":" + r, css: o[1], media: o[2], sourceMap: o[3] };
          i[l] ? i[l].parts.push(a) : n.push((i[l] = { id: l, parts: [a] }));
        }
        return n;
      }
      n.r(t),
      ...
      var o = {},
        l = r && (document.head || document.getElementsByTagName("head")[0]),
        a = null,
        s = 0,
        d = !1,
        u = function() {},
      ...
      function m(e) {
        var t,
          n,
          i = document.querySelector("style[" + c + '~="' + e.id + '"]');
        if (i) {
          if (d) return u;
